...
client.on("ready", () => {
    ...
    const presences = [
        ...
        { type: 'WATCHING',  message: `${client.guilds.cache.size} Servidores!`  },
        { type: 'WATCHING',  message:`${client.users.cache.size} Usuarios`  },
        { type: 'WATCHING',  message: 'El mejor bot!'  },
        { type: 'PLAYING',  message: 'En Desarrollo!'  },
        { type: 'WATCHING', message: 'c!help' }
    ];
...
client.on("messageCreate", async message => {
    ...
    if(!cmd){
        ...
        .setTitle("`❌ | Error!`")
        .setDescription(`Necesito que menciones algun comando.`)
        .setColor("RED")
        .setTimestamp();
...
client.login("OTg5OTg5NDYwMjQwMzkyMjUy.Gd6E2C.H3wvoxKLaC37kwfritrjc27Xr1RNRRtSdEzl3A")